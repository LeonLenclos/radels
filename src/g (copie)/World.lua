...
function World:isPropertyAt(property, x, y)
  return utils.find(self.objects, function(o)
    return o.life>0 and x==o.x and y==o.y and o:getProperty(property)
  end)
end
...
function World:update(dt)
  ...
  self.objects = utils.filter(self.objects, function(o) return o.life > 0 end)
end
...
function World:getRandomSpawnablePos(id)
  ...
  utils.shuffle(objectsCopy)
  for _, obj in ipairs(objectsCopy) do
